...
public class Demo01Layout extends RelativeLayout {
    ...
    public Demo01Layout(Context context) {
        this(context,null);
    }

    public Demo01Layout(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public Demo01Layout(Context context, AttributeSet attrs, int defStyleAttr) {
