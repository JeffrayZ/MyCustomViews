 ...
 * 点击事件与拖动事件的冲突处理
 * */
public class VDHLinearLayout03 extends LinearLayout {
    ...
    public VDHLinearLayout03(Context context) {
        this(context, null);
    }

    public VDHLinearLayout03(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VDHLinearLayout03(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public VDHLinearLayout03(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
